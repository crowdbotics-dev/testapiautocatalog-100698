...
## Project Structure
    ...
    ├── testapiautocatalog_100698  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_100698`
...
2. Clone this repo and `cd testapiautocatalog_100698`
